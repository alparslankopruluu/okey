...
- **fastlane snapshot**: a supported UI-test-driven capture lane. Its raw captures may
  feed HyperShots, but app-factory keeps screenshot upload under ASC plan/apply/readback.
