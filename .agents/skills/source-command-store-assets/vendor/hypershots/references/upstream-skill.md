...
| Submit the set to App Store Connect | parent `source-command-store-assets` skill | validate → stage reviewed locale set → `asc screenshots plan` → approved apply/readback |
