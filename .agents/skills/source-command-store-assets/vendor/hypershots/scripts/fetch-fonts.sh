...
# NOTE: the css2 fetch depends on a spoofed Chrome UA string and may break
# silently when Google changes response shapes. Prefer copying the woff2 assets
# and unicode-range css from the matching Fontsource npm package (the source of
# the kit's own vendored fonts, pinned at Fontsource 5.2.10) when one exists.
