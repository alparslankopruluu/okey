...
| Date | Idea | Source | Notes |
|---|---|---|---|
| 2026-08-11 | Playable Vite/React/Three.js browser client | Approved scope fence | V2; reuse game core and protocol |
| 2026-08-11 | Tournaments, leagues, clubs, public voice discovery | Product expansion | Requires moderation/operations evidence |
| 2026-08-11 | Direct messages and persistent social graph | Product expansion | Not required for reliable friend rooms |
| 2026-08-11 | More than Turkish/English | Localization | Add only with complete UI/store/support coverage |
| 2026-08-11 | Production chip-stake rooms | Economy | Blocked on legal/store classification; never cash value |
...
| 2026-08-11 | iOS/Android development-build and device acceptance matrix | Native gate | Blocked on local disk/tool cards plus signing/provider work |
